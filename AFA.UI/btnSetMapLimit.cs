...
namespace AFA.UI
{
	public class btnSetMapLimit : RibbonButton
	{
		private class btn_CommandHandler : ICommand
		{
			...
			public void Execute(object param)
			{
				...
				if (ribbonButton != null)
				{
					...
					string text = ".ESRI_SetCurrentMapLimit ";
		...
		public btnSetMapLimit()
		{
			...
			base.CommandHandler=(new btnSetMapLimit.btn_CommandHandler());
