...
namespace AFA.UI
{
	public class btnDiscardAllEdits : RibbonButton
	{
		...
		private string name = AfaStrings.RBN_BTN_DISCARDALLEDITS;

		private string tooltipTitle = AfaStrings.RBN_BTN_DISCARDALLEDITS_TOOLTIP_TITLE;

		private string tooltipDescr = AfaStrings.RBN_BTN_DISCARDALLEDITS_TOOLTIP;

		private string smallImageName = "img_discardalledits_small";

		private string largeImageName = "img_discardalledits_large";

		private RibbonItemSize btnsize;

		public btnDiscardAllEdits()
		{
			base.Id=(this.name);
			base.Name=(this.name);
			base.Text=(this.name);
			...
			base.CommandHandler=(new btnDiscardAllEdits.btn_CommandHandler());
