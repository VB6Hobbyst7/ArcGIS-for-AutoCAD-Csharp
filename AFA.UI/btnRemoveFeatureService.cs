...
namespace AFA.UI
{
	public class btnRemoveFeatureService : RibbonButton
	{
		...
		private string name = AfaStrings.RBN_BTN_REMOVEFEATURESERVICE;

		private string tooltipTitle = AfaStrings.RBN_BTN_REMOVEFEATURESERVICE_TOOLTIP_TITLE;

		private string tooltipDescr = AfaStrings.RBN_BTN_REMOVEFEATURESERVICE_TOOLTIP;

		private string smallImageName = "img_deletefeatureclass_small";

		private string largeImageName = "img_deletefeatureclass_large";

		private RibbonItemSize btnsize;

		public btnRemoveFeatureService()
		{
			base.Id=(this.name);
			base.Name=(this.name);
			base.Text=(this.name);
			...
			base.CommandHandler=(new btnRemoveFeatureService.btn_CommandHandler());
