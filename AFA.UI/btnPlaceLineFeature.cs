...
namespace AFA.UI
{
	public class btnPlaceLineFeature : RibbonSplitButton
	{
		...
		public btnPlaceLineFeature()
		{
			...
			base.CommandHandler=(new btnPlaceLineFeature.btn_CommandHandler());
			base.HelpSource=(ArcGISRibbon.HelpPath);
			base.Items.Add(new btnPlaceLine());
			base.Items.Add(new btnPlaceLWPline());
		}
	}
}
