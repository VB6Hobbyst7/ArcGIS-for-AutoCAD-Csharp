...
namespace AFA.UI
{
	public class btnSelectAll : RibbonButton
	{
		...
		private string name = AfaStrings.RBN_BTN_SELECTALL;

		private string tooltipTitle = AfaStrings.RBN_BTN_SELECTALL_TOOLTIP_TITLE;

		private string tooltipDescr = AfaStrings.RBN_BTN_SELECTALL_TOOLTIP;

		private string smallImageName = "img_selectall_small";

		private string largeImageName = "img_selectall_large";
		...
		public btnSelectAll()
		{
			...
			base.CommandHandler=(new btnSelectAll.btn_CommandHandler());
