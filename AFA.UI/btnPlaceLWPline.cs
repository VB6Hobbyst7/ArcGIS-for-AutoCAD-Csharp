...
namespace AFA.UI
{
	public class btnPlaceLWPline : RibbonButton
	{
		...
		private string name = "Place LW Pline";

		private string tooltipTitle = "Place LW Pline";

		private string tooltipDescr = "Place LW Pline";
		...
		public btnPlaceLWPline()
		{
			...
			base.CommandHandler=(new btnPlaceLWPline.btn_CommandHandler());
