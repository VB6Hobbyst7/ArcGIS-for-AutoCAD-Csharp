...
namespace AFA.UI
{
	public class btnDiscardEdits : RibbonButton
	{
		private class btn_CommandHandler : ICommand
		{
			...
			public void Execute(object param)
			{
				...
				if (ribbonButton != null)
				{
					...
					string cmdString = ".esri_DiscardEdits ";
		...
		private string name = AfaStrings.RBN_BTN_DISCARDEDITS;

		private string tooltipTitle = AfaStrings.RBN_BTN_DISCARDEDITS_TOOLTIP_TITLE;

		private string tooltipDescr = AfaStrings.RBN_BTN_DISCARDEDITS_TOOLTIP;

		private string smallImageName = "img_discardedits_small";

		private string largeImageName = "img_discardedits_large";

		private RibbonItemSize btnsize;

		public btnDiscardEdits()
		{
			base.Id=(this.name);
			base.Name=(this.name);
			base.Text=(this.name);
			...
			base.CommandHandler=(new btnDiscardEdits.btn_CommandHandler());
